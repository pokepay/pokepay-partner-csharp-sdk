...
Request.GetPrivateMoneyOrganizationSummaries request = new Request.GetPrivateMoneyOrganizationSummaries(
    ...
    From = "2024-04-03T10:48:47.000000Z",  // 開始日時(toと同時に指定する必要有)
    To = "2023-06-20T13:53:59.000000Z",  // 終了日時(fromと同時に指定する必要有)
    Page = 1,  // ページ番号
...
Request.GetPrivateMoneySummary request = new Request.GetPrivateMoneySummary(
    ...
    From = "2021-04-22T03:41:13.000000Z",  // 開始日時
    To = "2021-08-14T09:16:00.000000Z",  // 終了日時
};

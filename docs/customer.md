...
Request.ListAccountBalances request = new Request.ListAccountBalances(
    ...
    Page = 8866,  // ページ番号
    PerPage = 3788,  // 1ページ分の取引数
    ExpiresAtFrom = "2024-05-08T08:02:58.000000Z",  // 有効期限の期間によるフィルター(開始時点)
    ExpiresAtTo = "2020-07-10T15:31:52.000000Z",  // 有効期限の期間によるフィルター(終了時点)
...
Request.ListAccountExpiredBalances request = new Request.ListAccountExpiredBalances(
    ...
    Page = 9893,  // ページ番号
    PerPage = 5144,  // 1ページ分の取引数
    ExpiresAtFrom = "2023-07-30T13:21:18.000000Z",  // 有効期限の期間によるフィルター(開始時点)
    ExpiresAtTo = "2022-03-10T23:36:17.000000Z",  // 有効期限の期間によるフィルター(終了時点)
    Direction = "desc",  // 有効期限によるソート順序
};
Response.PaginatedAccountBalance response = await request.Send(client);
```
...
Request.UpdateCustomerAccount request = new Request.UpdateCustomerAccount(
    ...
    AccountName = "Mob2yqEgXsKX0DNjA5LloLW2ZGwTADg0EGo2tY0BvAArU4c3Hcr3rYtMZs1YhEQlphw1DkmThPoIdPA7X1r",  // アカウント名
    ExternalId = "8JTPyIk7mw",  // 外部ID
...
Request.GetCustomerAccounts request = new Request.GetCustomerAccounts(
    ...
    Page = 9657,  // ページ番号
    PerPage = 8463,  // 1ページ分のウォレット数
    CreatedAtFrom = "2024-08-27T14:42:17.000000Z",  // ウォレット作成日によるフィルター(開始時点)
    CreatedAtTo = "2020-10-21T08:02:23.000000Z",  // ウォレット作成日によるフィルター(終了時点)
    IsSuspended = true,  // ウォレットが凍結状態かどうかでフィルターする
    Status = "suspended",  // ウォレット状態
    ExternalId = "kHcNMgqN77FQwuiGtQW4pnFSkfz0ZAY",  // 外部ID
    Tel = "050-52-1809",  // エンドユーザーの電話番号
    Email = "ga8rAwXpAi@qwTx.com",  // エンドユーザーのメールアドレス
};
...
Request.GetShopAccounts request = new Request.GetShopAccounts(
    ...
    Page = 706,  // ページ番号
    PerPage = 6573,  // 1ページ分のウォレット数
    CreatedAtFrom = "2024-06-29T19:02:03.000000Z",  // ウォレット作成日によるフィルター(開始時点)
    CreatedAtTo = "2022-06-02T11:28:22.000000Z",  // ウォレット作成日によるフィルター(終了時点)
    IsSuspended = true,  // ウォレットが凍結状態かどうかでフィルターする
};
Response.PaginatedAccountWithUsers response = await request.Send(client);
```
...
Request.ListCustomerTransactions request = new Request.ListCustomerTransactions(
    ...
    From = "2022-08-03T03:36:55.000000Z",  // 開始日時
    To = "2022-02-07T14:54:32.000000Z",  // 終了日時
    Page = 1,  // ページ番号

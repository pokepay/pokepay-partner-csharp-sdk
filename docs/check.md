...
Request.ListChecks request = new Request.ListChecks() {
    ...
    OrganizationCode = "vn9tkKJsfEeEirDJBvMOLUpWvpkfaBwA",  // 組織コード
    ExpiresFrom = "2023-10-29T22:56:27.000000Z",  // 有効期限の期間によるフィルター(開始時点)
    ExpiresTo = "2020-11-26T08:56:40.000000Z",  // 有効期限の期間によるフィルター(終了時点)
    CreatedFrom = "2024-11-20T07:44:01.000000Z",  // 作成日時の期間によるフィルター(開始時点)
    CreatedTo = "2022-12-31T07:37:03.000000Z",  // 作成日時の期間によるフィルター(終了時点)
    IssuerShopId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // 発行店舗ID
    Description = "bJ1KgmPI",  // チャージQRコードの説明文
...
Request.CreateCheck request = new Request.CreateCheck(
    ...
    MoneyAmount = 8695.0,  // 付与マネー額
    PointAmount = 2448.0,  // 付与ポイント額
    Description = "test check",  // 説明文(アプリ上で取引の説明文として表示される)
    IsOnetime = true,  // ワンタイムかどうかのフラグ
    UsageLimit = 9003,  // ワンタイムでない場合の最大読み取り回数
    ExpiresAt = "2023-05-15T14:39:15.000000Z",  // チャージQRコード自体の失効日時
    PointExpiresAt = "2022-05-25T17:43:42.000000Z",  // チャージQRコードによって付与されるポイント残高の有効期限
...
Request.UpdateCheck request = new Request.UpdateCheck(
    ...
    MoneyAmount = 4892.0,  // 付与マネー額
    PointAmount = 3363.0,  // 付与ポイント額
    Description = "test check",  // チャージQRコードの説明文
    IsOnetime = true,  // ワンタイムかどうかのフラグ
    UsageLimit = 1755,  // ワンタイムでない場合の最大読み取り回数
    ExpiresAt = "2020-06-28T00:01:59.000000Z",  // チャージQRコード自体の失効日時
    PointExpiresAt = "2021-11-12T06:55:45.000000Z",  // チャージQRコードによって付与されるポイント残高の有効期限
    PointExpiresInDays = 60,  // チャージQRコードによって付与されるポイント残高の有効期限(相対日数指定)
    BearPointAccount = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // ポイント額を負担する店舗のウォレットID

...
Request.ListChecks request = new Request.ListChecks() {
    ...
    OrganizationCode = "OdsQM2IVUV93tsgT",  // 組織コード
    ExpiresFrom = "2022-12-31T07:11:44.000000Z",  // 有効期限の期間によるフィルター(開始時点)
    ExpiresTo = "2023-07-06T02:13:30.000000Z",  // 有効期限の期間によるフィルター(終了時点)
    CreatedFrom = "2023-12-05T11:42:27.000000Z",  // 作成日時の期間によるフィルター(開始時点)
    CreatedTo = "2022-09-02T10:02:45.000000Z",  // 作成日時の期間によるフィルター(終了時点)
...
Request.CreateCheck request = new Request.CreateCheck(
    ...
    MoneyAmount = 4897.0,  // 付与マネー額
    PointAmount = 4976.0,  // 付与ポイント額
    Description = "test check",  // 説明文(アプリ上で取引の説明文として表示される)
    IsOnetime = false,  // ワンタイムかどうかのフラグ
    UsageLimit = 662,  // ワンタイムでない場合の最大読み取り回数
    ExpiresAt = "2020-04-17T14:22:02.000000Z",  // チャージQRコード自体の失効日時
    PointExpiresAt = "2024-02-14T19:55:45.000000Z",  // チャージQRコードによって付与されるポイント残高の有効期限
...
Request.UpdateCheck request = new Request.UpdateCheck(
    ...
    MoneyAmount = 494.0,  // 付与マネー額
    PointAmount = 9481.0,  // 付与ポイント額
    Description = "test check",  // チャージQRコードの説明文
    IsOnetime = false,  // ワンタイムかどうかのフラグ
    UsageLimit = 4095,  // ワンタイムでない場合の最大読み取り回数
    ExpiresAt = "2022-07-05T02:15:16.000000Z",  // チャージQRコード自体の失効日時
    PointExpiresAt = "2020-03-09T17:29:09.000000Z",  // チャージQRコードによって付与されるポイント残高の有効期限
    PointExpiresInDays = 60,  // チャージQRコードによって付与されるポイント残高の有効期限(相対日数指定)
    BearPointAccount = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // ポイント額を負担する店舗のウォレットID

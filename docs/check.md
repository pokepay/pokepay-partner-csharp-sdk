...
Request.ListChecks request = new Request.ListChecks() {
    ...
    OrganizationCode = "1DHEyhnbl8ZtF",  // 組織コード
    ExpiresFrom = "2024-11-02T00:14:28.000000Z",  // 有効期限の期間によるフィルター(開始時点)
    ExpiresTo = "2026-01-19T11:34:24.000000Z",  // 有効期限の期間によるフィルター(終了時点)
    StartsFrom = "2020-08-25T20:21:23.000000Z",  // 有効開始日時の期間によるフィルター(開始時点)
    StartsTo = "2025-12-26T18:08:18.000000Z",  // 有効開始日時の期間によるフィルター(終了時点)
    CreatedFrom = "2024-08-30T23:09:13.000000Z",  // 作成日時の期間によるフィルター(開始時点)
    CreatedTo = "2021-03-05T15:33:16.000000Z",  // 作成日時の期間によるフィルター(終了時点)
...
Request.CreateCheck request = new Request.CreateCheck(
    ...
    MoneyAmount = 1830.0,  // 付与マネー額
    PointAmount = 6112.0,  // 付与ポイント額
    Description = "test check",  // 説明文(アプリ上で取引の説明文として表示される)
    IsOnetime = false,  // ワンタイムかどうかのフラグ
    UsageLimit = 7171,  // ワンタイムでない場合の最大読み取り回数
    ExpiresAt = "2024-01-01T15:47:40.000000Z",  // チャージQRコード自体の失効日時
    StartsAt = "2026-09-08T07:11:23.000000Z",  // チャージQRコード有効開始日時
    PointExpiresAt = "2026-08-28T18:59:35.000000Z",  // チャージQRコードによって付与されるポイント残高の有効期限
...
Request.UpdateCheck request = new Request.UpdateCheck(
    ...
    MoneyAmount = 4500.0,  // 付与マネー額
    PointAmount = 3074.0,  // 付与ポイント額
    Description = "test check",  // チャージQRコードの説明文
    IsOnetime = false,  // ワンタイムかどうかのフラグ
    UsageLimit = 2623,  // ワンタイムでない場合の最大読み取り回数
    ExpiresAt = "2026-01-13T10:34:49.000000Z",  // チャージQRコード自体の失効日時
    StartsAt = "2025-05-01T08:30:41.000000Z",  // チャージQRコード有効開始日時
    PointExpiresAt = "2025-04-12T17:39:57.000000Z",  // チャージQRコードによって付与されるポイント残高の有効期限
    PointExpiresInDays = 60,  // チャージQRコードによって付与されるポイント残高の有効期限(相対日数指定)
    BearPointAccount = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // ポイント額を負担する店舗のウォレットID

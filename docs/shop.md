...
Request.ListShops request = new Request.ListShops() {
    ...
    Name = "oxスーパー三田店",  // 店舗名
    PostalCode = "065-8841",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "035394-661",  // 店舗の電話番号
    Email = "PYajb0tVdW@EdtL.com",  // 店舗のメールアドレス
    ExternalId = "ujHbA770c9iXi2",  // 店舗の外部ID
...
Request.CreateShop request = new Request.CreateShop(
    ...
    ShopPostalCode = "116-6740",  // 店舗の郵便番号
    ShopAddress = "東京都港区芝...",  // 店舗の住所
    ShopTel = "0915128384",  // 店舗の電話番号
    ShopEmail = "0BrHHw3tEd@BOJZ.com",  // 店舗のメールアドレス
    ShopExternalId = "fpIFBg2EP1IMpzVlOR0ZjHbJ4pIYeH1mIjK9",  // 店舗の外部ID
...
Request.CreateShopV2 request = new Request.CreateShopV2(
    ...
    PostalCode = "129-2649",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "09-22-9485",  // 店舗の電話番号
    Email = "gMUhIRyB0L@q7z8.com",  // 店舗のメールアドレス
    ExternalId = "jil9JSMA7rA7m",  // 店舗の外部ID
    OrganizationCode = "ox-supermarket",  // 組織コード
...
Request.UpdateShop request = new Request.UpdateShop(
    ...
    Name = "oxスーパー三田店",  // 店舗名
    PostalCode = "049-6375",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "01-63719334",  // 店舗の電話番号
    Email = "YIDOJbPEul@QIvN.com",  // 店舗のメールアドレス
    ExternalId = "kQALktsxpQNr6y6a28m0",  // 店舗の外部ID

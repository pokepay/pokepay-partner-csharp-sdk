...
Request.ListShops request = new Request.ListShops() {
    ...
    Name = "oxスーパー三田店",  // 店舗名
    PostalCode = "455-3105",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "07-8224777",  // 店舗の電話番号
    Email = "XFXl4NKb3z@ycQe.com",  // 店舗のメールアドレス
    ExternalId = "aty6OYZVBO6i7OrH9y83QqXgWF2opiVdC1V",  // 店舗の外部ID
...
Request.CreateShop request = new Request.CreateShop(
    ...
    ShopPostalCode = "2531136",  // 店舗の郵便番号
    ShopAddress = "東京都港区芝...",  // 店舗の住所
    ShopTel = "0946-3867-477",  // 店舗の電話番号
    ShopEmail = "VKG4nhx51A@wtpZ.com",  // 店舗のメールアドレス
    ShopExternalId = "v6uv80k2eZ",  // 店舗の外部ID
...
Request.CreateShopV2 request = new Request.CreateShopV2(
    ...
    PostalCode = "1822560",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "08415170",  // 店舗の電話番号
    Email = "KgCzW91ijq@wGz4.com",  // 店舗のメールアドレス
    ExternalId = "wxLvGQu8AItYv5ALjIimTwKA5k60bA481CWC",  // 店舗の外部ID
    OrganizationCode = "ox-supermarket",  // 組織コード
...
Request.UpdateShop request = new Request.UpdateShop(
    ...
    Name = "oxスーパー三田店",  // 店舗名
    PostalCode = "9323713",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "0225-822",  // 店舗の電話番号
    Email = "oQlLinyfuc@6vmm.com",  // 店舗のメールアドレス
    ExternalId = "pmKFDO4dzrTnN2hnl6jClpe10uHCcb",  // 店舗の外部ID

...
Request.ListBills request = new Request.ListBills() {
    Page = 7282,  // ページ番号
    PerPage = 5418,  // 1ページの表示数
    BillId = "RCH16a",  // 支払いQRコードのID
    PrivateMoneyId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // マネーID
    OrganizationCode = "0ciEEhu",  // 組織コード
    Description = "test bill",  // 取引説明文
    CreatedFrom = "2024-04-06T11:03:17.000000Z",  // 作成日時(起点)
    CreatedTo = "2024-07-21T22:56:26.000000Z",  // 作成日時(終点)
    ShopName = "bill test shop1",  // 店舗名
    ShopId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // 店舗ID
    LowerLimitAmount = 9077,  // 金額の範囲によるフィルタ(下限)
    UpperLimitAmount = 6381,  // 金額の範囲によるフィルタ(上限)

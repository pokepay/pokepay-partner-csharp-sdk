...
Request.GetCpmToken request = new Request.GetCpmToken(
    "vWBubinmpHH9otuveTS9fU" // CPMトークン
);
...
```csharp
Request.ListTransactions request = new Request.ListTransactions() {
    From = "2020-05-04T15:57:28.000000+09:00",  // 開始日時
    To = "2021-12-09T07:20:36.000000+09:00",  // 終了日時
    Page = 1,  // ページ番号
...
Request.CreateTransaction request = new Request.CreateTransaction(
    ...
    MoneyAmount = 1513,
    PointAmount = 1880,
    PointExpiresAt = "2023-04-06T12:23:01.000000+09:00",  // ポイント有効期限
    Description = "mnhkPQ0ETyOT6FMC7gPs49FFy1zgreNMR26yFTTvLGXqmygvpFWyQA89NWgsbu7qwo3KsP9G1Zc4im3eTSjyyMt9XgWt0tifLCcpFG9sHSm67eebY2opWkO8L5pCfnxKQdMUIjxZwgFMvAwYD77kMVlgzfz4Kslt3maAci1eREIoa3xd5JdmZXFAwgF7lVJ47QIhj",
};
...
Request.ListTransactionsV2 request = new Request.ListTransactionsV2() {
    ...
    CustomerName = "太郎",  // エンドユーザー名
    Description = "店頭QRコードによる支払い",  // 取引説明文
    TransactionId = "sKO1s7",  // 取引ID
    IsModified = true,  // キャンセルフラグ
    Types = new string[]{"topup", "payment"},  // 取引種別 (複数指定可)、チャージ=topup、支払い=payment
    From = "2020-07-21T08:23:42.000000+09:00",  // 開始日時
    To = "2022-12-20T10:45:51.000000+09:00",  // 終了日時
...
Request.CreateTopupTransaction request = new Request.CreateTopupTransaction(
    ...
    MoneyAmount = 4408,  // マネー額
    PointAmount = 9635,  // ポイント額
    PointExpiresAt = "2021-08-14T09:41:17.000000+09:00",  // ポイント有効期限
...
Request.CreateCpmTransaction request = new Request.CreateCpmTransaction(
    "VY4arI9AS3ohT8jb2adTN3", // CPMトークン
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // 店舗ID
    5605.0 // 取引金額
) {
...
Request.CreateExchangeTransaction request = new Request.CreateExchangeTransaction(
    ...
    Description = "em0YmS5iHyeTMph1sqZvs6xb4dnB1lRhZsNVVvWqMauyEy2DHStpF4h1sIw2x48vtCTqxgKh4g4bscJQFGY3onDkoWsqwIiqGXfmbcYnwqERZuD2XLoIr6pYvcAep8K0EL5F9OyRCkJPRRkJAvrRmGmkHM9IcYVs",
    RequestId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // リクエストID
};
Response.TransactionDetail response = await request.Send(client);
```
...
Request.RefundTransaction request = new Request.RefundTransaction(
    ...
    ReturningPointExpiresAt = "2022-03-12T08:30:27.000000+09:00",  // 返却ポイントの有効期限
};
Response.TransactionDetail response = await request.Send(client);
```
...
Request.GetAccountTransferSummary request = new Request.GetAccountTransferSummary(
    ...
    From = "2020-10-30T23:38:53.000000+09:00",  // 集計期間の開始時刻
    To = "2020-10-21T22:59:39.000000+09:00",  // 集計期間の終了時刻
...
Request.ListTransfers request = new Request.ListTransfers() {
    From = "2022-07-19T13:36:18.000000+09:00",
    To = "2023-04-22T19:55:18.000000+09:00",
    Page = 6909,
    PerPage = 587,
    ShopId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
    ShopName = "N87fg3xWR8VoOypRzeCEZnTAMsFEe1EY9wUETySwpJ9DUm4NUQSzUkMvCVVdw92OUkul6q4XayADAlDUtDo9rxesHEycq058ZBCm97BPvlturs90Of5ygFO8DRJPQgKeqmnqDLIOjurqUgAOeiA5CTmqSyWgIYZapC86ZjPn73FGPYzifBcDImRQ2roynNdRzRcoIXUEp9pCHreba3N4XpChdUTt4vVVRMVNXjhbnlgnh49hI65GI84lo24dP",
    CustomerId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
    CustomerName = "r9Y8cncN0vfXEgOCTsLUoUAU7zf4LjqrmaM0iuCZLgk9QBkBF1ZE17yDaslZww4XSfPzRYFCSreeBtCZgOxDZBxRLi16cBPhjE5aozbd4euZKMnOcihbTiqsSNhlIOIaM6ul33JQUcR9kqAwczFzt3j6QCd9N7BkrxTG3NlMIO8lFlnROlxKwJHb2AvK6U8AkV9AiwB3CQhtuJOfoVrI0YZYYfL97ZoTvqm31rIy8eqKJe7ISbbt72PTN",
    ...
    TransferTypes = new string[]{"cashback", "topup", "payment", "coupon", "campaign"},  // 取引明細の種類でフィルターします。
...
Request.ListTransfersV2 request = new Request.ListTransfersV2() {
    ShopId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // 店舗ID
    ShopName = "dX0OUC5Ne5O0GZFvLGcgX3oT0pMuGa7YrwSgHXsVXMRBE2nWGKCrR1hVIfiKdPAc2bUqA3H5adRMfxv3Nas41wNdPXygKrdBxRNzCSlBGjGivP1jp6GsP8UZoHOC9JCDnaa0LGuXQP2eKdO9C8wJW9fsEe1qTZnVBbcUmvgWRbrpIvf5gZsaHn09fi8",  // 店舗名
    CustomerId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // エンドユーザーID
    CustomerName = "ILFnLp2Sy2vsqvzRkg29Y3DmnYyk005upb1zE0AOuVWuqxvAiHseLOpA9HLpdHmCtx0eZk7KWjZJYmuCAvoVYBD9jZ030fAjJJ9RpJi9iz6GUwGDK1cXVDMDobIMQAJJUPjvj4gHhIpkchVvBGsV67Rk8CWj6NhEqJr34X9QeVuo8eOJ95tTsq8ApmkPK1oYlpytz7L5v2IeFsSB7VSyokWq0wpgXygInathKiAwp4wSjH1soUvltG",  // エンドユーザー名
    TransactionId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // 取引ID
    PrivateMoneyId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // マネーID
    IsModified = true,  // キャンセルフラグ
    TransactionTypes = new string[]{"cashback", "expire", "topup", "payment"},  // 取引種別 (複数指定可)、チャージ=topup、支払い=payment
    ...
    PerPage = 50,  // 1ページ分の取引数
    TransferTypes = new string[]{"coupon", "transfer", "topup", "payment", "campaign", "cashback", "exchange"},  // 取引明細種別 (複数指定可)
    Description = "店頭QRコードによる支払い",  // 取引詳細説明文
    From = "2021-02-24T15:47:20.000000+09:00",  // 開始日時
    To = "2021-05-13T12:11:42.000000+09:00",  // 終了日時
};
...
Request.CreateCheck request = new Request.CreateCheck(
    ...
    MoneyAmount = 512.0,  // 付与マネー額
    PointAmount = 7853.0,  // 付与ポイント額
    Description = "test check",  // 説明文(アプリ上で取引の説明文として表示される)
    IsOnetime = true,  // ワンタイムかどうかのフラグ
    UsageLimit = 5325,  // ワンタイムでない場合の最大読み取り回数
    ExpiresAt = "2022-11-05T06:52:45.000000+09:00",  // チャージQRコード自体の失効日時
    PointExpiresAt = "2022-04-13T21:57:26.000000+09:00",  // チャージQRコードによって付与されるポイント残高の有効期限
...
Request.ListChecks request = new Request.ListChecks() {
    ...
    PerPage = 50,  // 1ページの表示数
    PrivateMoneyId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // マネーID
    OrganizationCode = "44cTz91VskUrlGiCnBXpYIWUY",  // 組織コード
    ExpiresFrom = "2023-06-20T21:57:58.000000+09:00",  // 有効期限の期間によるフィルター(開始時点)
    ExpiresTo = "2021-06-30T06:07:37.000000+09:00",  // 有効期限の期間によるフィルター(終了時点)
    CreatedFrom = "2020-02-18T03:59:32.000000+09:00",  // 作成日時の期間によるフィルター(開始時点)
    CreatedTo = "2020-03-28T17:20:45.000000+09:00",  // 作成日時の期間によるフィルター(終了時点)
    IssuerShopId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // 発行店舗ID
    Description = "7",  // チャージQRコードの説明文
...
Request.UpdateCheck request = new Request.UpdateCheck(
    ...
    MoneyAmount = 8076.0,  // 付与マネー額
    PointAmount = 4332.0,  // 付与ポイント額
    Description = "test check",  // チャージQRコードの説明文
    IsOnetime = true,  // ワンタイムかどうかのフラグ
    UsageLimit = 2451,  // ワンタイムでない場合の最大読み取り回数
    ExpiresAt = "2022-06-27T20:26:53.000000+09:00",  // チャージQRコード自体の失効日時
    PointExpiresAt = "2022-07-03T16:47:10.000000+09:00",  // チャージQRコードによって付与されるポイント残高の有効期限
    PointExpiresInDays = 60,  // チャージQRコードによって付与されるポイント残高の有効期限(相対日数指定)
    BearPointAccount = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // ポイント額を負担する店舗のウォレットID
...
Request.ListBills request = new Request.ListBills() {
    Page = 5978,  // ページ番号
    PerPage = 4348,  // 1ページの表示数
    BillId = "Ssti4OCJh",  // 支払いQRコードのID
    PrivateMoneyId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // マネーID
    OrganizationCode = "m8I-2qh4-l0-51g9e-S",  // 組織コード
    Description = "test bill",  // 取引説明文
    CreatedFrom = "2023-04-02T10:03:47.000000+09:00",  // 作成日時(起点)
    CreatedTo = "2022-07-28T18:53:28.000000+09:00",  // 作成日時(終点)
    ShopName = "bill test shop1",  // 店舗名
    ShopId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // 店舗ID
    LowerLimitAmount = 1052,  // 金額の範囲によるフィルタ(下限)
    UpperLimitAmount = 7196,  // 金額の範囲によるフィルタ(上限)
...
Request.ListAccountBalances request = new Request.ListAccountBalances(
    ...
    Page = 203,  // ページ番号
    PerPage = 1632,  // 1ページ分の取引数
    ExpiresAtFrom = "2020-10-27T12:42:46.000000+09:00",  // 有効期限の期間によるフィルター(開始時点)
    ExpiresAtTo = "2021-01-11T11:27:38.000000+09:00",  // 有効期限の期間によるフィルター(終了時点)
...
Request.ListAccountExpiredBalances request = new Request.ListAccountExpiredBalances(
    ...
    Page = 8522,  // ページ番号
    PerPage = 1238,  // 1ページ分の取引数
    ExpiresAtFrom = "2023-12-14T01:04:11.000000+09:00",  // 有効期限の期間によるフィルター(開始時点)
    ExpiresAtTo = "2021-01-11T15:33:15.000000+09:00",  // 有効期限の期間によるフィルター(終了時点)
    Direction = "desc",  // 有効期限によるソート順序
};
Response.PaginatedAccountBalance response = await request.Send(client);
```
...
Request.UpdateCustomerAccount request = new Request.UpdateCustomerAccount(
    ...
    AccountName = "anhWUsKdseQDoEi3f96NOnuKHLCJQ5hg0Jy37lRWAXNz9gVUnuYjjEsH2aOYArNPAIoL8Sd1eEKEVQFfnJbxYGora5JqEgNaWOu3Lpa6fEO2CZB9qaEv7RDCV0O4bn0cVjhvU5mOgKT5uZQDiHYWS79y4Q7B45Wxla0ctfQ9",  // アカウント名
    ExternalId = "nYJkz3o8hG5HbXD",  // 外部ID
...
Request.GetCustomerAccounts request = new Request.GetCustomerAccounts(
    ...
    Page = 5245,  // ページ番号
    PerPage = 2235,  // 1ページ分のウォレット数
    CreatedAtFrom = "2021-01-20T21:51:03.000000+09:00",  // ウォレット作成日によるフィルター(開始時点)
    CreatedAtTo = "2022-06-28T18:15:37.000000+09:00",  // ウォレット作成日によるフィルター(終了時点)
    IsSuspended = true,  // ウォレットが凍結状態かどうかでフィルターする
    Status = "suspended",  // ウォレット状態
    ExternalId = "wrbY1oZi3BxILFhUVz8Tsqk3NQ",  // 外部ID
    Tel = "011-817520",  // エンドユーザーの電話番号
    Email = "FfDQ84LwAd@O6am.com",  // エンドユーザーのメールアドレス
};
...
Request.GetShopAccounts request = new Request.GetShopAccounts(
    ...
    Page = 7231,  // ページ番号
    PerPage = 1957,  // 1ページ分のウォレット数
    CreatedAtFrom = "2022-05-23T16:50:16.000000+09:00",  // ウォレット作成日によるフィルター(開始時点)
    CreatedAtTo = "2020-09-21T14:36:02.000000+09:00",  // ウォレット作成日によるフィルター(終了時点)
    IsSuspended = true,  // ウォレットが凍結状態かどうかでフィルターする
};
Response.PaginatedAccountWithUsers response = await request.Send(client);
```
...
Request.ListCustomerTransactions request = new Request.ListCustomerTransactions(
    ...
    From = "2022-11-28T04:10:34.000000+09:00",  // 開始日時
    To = "2022-05-29T19:46:39.000000+09:00",  // 終了日時
    Page = 1,  // ページ番号
    PerPage = 50,  // 1ページ分の取引数
};
Response.PaginatedTransaction response = await request.Send(client);
...
Request.ListShops request = new Request.ListShops() {
    ...
    PrivateMoneyId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // マネーID
    Name = "oxスーパー三田店",  // 店舗名
    PostalCode = "789-4646",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "03965-2990",  // 店舗の電話番号
    Email = "3gxL72tMZ9@dZhU.com",  // 店舗のメールアドレス
    ExternalId = "rpMvhZtnleaGpWEmC",  // 店舗の外部ID
...
Request.CreateShop request = new Request.CreateShop(
    ...
    ShopPostalCode = "206-1618",  // 店舗の郵便番号
    ShopAddress = "東京都港区芝...",  // 店舗の住所
    ShopTel = "053-08-8627",  // 店舗の電話番号
    ShopEmail = "ywgWLp44Rb@IdKW.com",  // 店舗のメールアドレス
    ShopExternalId = "bJXaujrG1XcWPgS",  // 店舗の外部ID
...
Request.CreateShopV2 request = new Request.CreateShopV2(
    ...
    PostalCode = "717-2537",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "090484-1680",  // 店舗の電話番号
    Email = "2k6wssvtiG@bJyv.com",  // 店舗のメールアドレス
    ExternalId = "Dst3DTk",  // 店舗の外部ID
    OrganizationCode = "ox-supermarket",  // 組織コード
...
Request.UpdateShop request = new Request.UpdateShop(
    ...
    Name = "oxスーパー三田店",  // 店舗名
    PostalCode = "124-3167",  // 店舗の郵便番号
    Address = "東京都港区芝...",  // 店舗の住所
    Tel = "09-8640763",  // 店舗の電話番号
    Email = "1VEMb3XHrh@p0zj.com",  // 店舗のメールアドレス
    ExternalId = "uM5JRhIp8Sk9ZehxoHi",  // 店舗の外部ID
...
Request.CreateUserAccount request = new Request.CreateUserAccount(
    ...
    Name = "BVz6S65b9Tb2c3LFv66DPYZeVxkNOORlNi3mWIl0ptLvc4BbBfaHZjjgyXM3czxcFX8Wc90xnlbFwe26P7WnASNdyhWIp6ipB4qlr51n6Dbi36872OrJY0JHe2ML5uo5FN2RyR",  // ウォレット名
    ExternalId = "bID2w3mfedT0be6XlLvtxI",  // 外部ID
    Metadata = "{\"key1\":\"foo\",\"key2\":\"bar\"}",  // ウォレットに付加するメタデータ
};
Response.AccountDetail response = await request.Send(client);
```
...
Request.GetPrivateMoneyOrganizationSummaries request = new Request.GetPrivateMoneyOrganizationSummaries(
    ...
    From = "2021-03-18T19:48:07.000000+09:00",  // 開始日時(toと同時に指定する必要有)
    To = "2020-05-08T08:14:47.000000+09:00",  // 終了日時(fromと同時に指定する必要有)
    Page = 1,  // ページ番号
    PerPage = 50,  // 1ページ分の取引数
};
...
Request.GetPrivateMoneySummary request = new Request.GetPrivateMoneySummary(
    ...
    From = "2023-05-08T16:32:22.000000+09:00",  // 開始日時
    To = "2020-02-13T08:29:24.000000+09:00",  // 終了日時
};
...
Request.BulkCreateTransaction request = new Request.BulkCreateTransaction(
    "DJDXO61NiXa7rD", // 一括取引タスク名
    "LJUnHi", // 取引する情報のCSV
    "jvrMg6Bfi1Ec5iFBuI46SraQFb0IHjqnJ7sf" // リクエストID
) {
    Description = "zmx3HeComNdex1VEBDHWbvYOKY3",  // 一括取引の説明
    PrivateMoneyId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // マネーID
};
...
Request.CreateCampaign request = new Request.CreateCampaign(
    "UkGY9w7mO1piYJd9sAooy6yuBqMXdRTKVKnzCSsJCQT6KIgTfiNpTfU3yLsekb9MJHCSl7", // キャンペーン名
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // マネーID
    "2020-12-20T07:09:44.000000+09:00", // キャンペーン開始日時
    "2023-02-21T01:20:55.000000+09:00", // キャンペーン終了日時
    4740, // キャンペーンの適用優先度
    "topup" // イベント種別
) {
    BearPointShopId = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",  // ポイント負担先店舗ID
    Description = "6yMsQU5Yg0N0l1BLynPufBqbuESl6hkzEqrQYEU7SWXSOCCgm1v7IczrvIzm",  // キャンペーンの説明文
    Status = "disabled",  // キャンペーン作成時の状態
    PointExpiresAt = "2020-05-30T21:29:44.000000+09:00",  // ポイント有効期限(絶対日時指定)
    PointExpiresInDays = 9326,  // ポイント有効期限(相対日数指定)
    ...
    ApplicableDaysOfWeek = new int[]{1},  // キャンペーンを適用する曜日 (複数指定)
    ...
    MinimumNumberForCombinationPurchase = 9484,  // 複数種類の商品を同時購入するときの商品種別数の下限
    ExistInEachProductGroups = false,  // 複数の商品グループにつき1種類以上の商品購入によって発火するキャンペーンの指定フラグ
    MaxPointAmount = 9965,  // キャンペーンによって付与されるポイントの上限
    MaxTotalPointAmount = 3012,  // キャンペーンによって付与されるの1人当たりの累計ポイントの上限
    ...
    BudgetCapsAmount = 1690484933,  // キャンペーン予算上限
};
...
Request.ListCampaigns request = new Request.ListCampaigns(
    ...
    AvailableFrom = "2022-08-14T14:19:00.000000+09:00",  // 指定された日時以降に適用可能期間が含まれているか
    AvailableTo = "2022-05-05T01:31:40.000000+09:00",  // 指定された日時以前に適用可能期間が含まれているか
    Page = 1,  // ページ番号
...
Request.UpdateCampaign request = new Request.UpdateCampaign(
    ...
    Name = "dXbI8lpfjhFb8EJFK2yIUjURP14kOTuWGxunt98QSAgSk8pKef",  // キャンペーン名
    StartsAt = "2022-12-07T07:44:59.000000+09:00",  // キャンペーン開始日時
    EndsAt = "2022-04-03T05:49:05.000000+09:00",  // キャンペーン終了日時
    Priority = 1966,  // キャンペーンの適用優先度
    Event = "payment",  // イベント種別
    Description = "mHCA1ZiMTcT44Iw6afb0aRMTqGuUUShi66PzlcEC7vCfYTfkj7M01xDpuUvE76gOViIko1qYZJcAUztQr",  // キャンペーンの説明文
    Status = "disabled",  // キャンペーン作成時の状態
    PointExpiresAt = "2023-10-01T15:37:16.000000+09:00",  // ポイント有効期限(絶対日時指定)
    PointExpiresInDays = 7519,  // ポイント有効期限(相対日数指定)
    ...
    ApplicableDaysOfWeek = new int[]{5},  // キャンペーンを適用する曜日 (複数指定)
    ApplicableTimeRanges = new object[]{new Dictionary<string, object>(){{"from","12:00"}, {"to","23:59"}}, new Dictionary<string, object>(){{"from","12:00"}, {"to","23:59"}}},  // キャンペーンを適用する時間帯 (複数指定)
    ApplicableShopIds = new string[]{"xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"},  // キャンペーン適用対象となる店舗IDのリスト
    MinimumNumberForCombinationPurchase = 6441,  // 複数種類の商品を同時購入するときの商品種別数の下限
    ExistInEachProductGroups = false,  // 複数の商品グループにつき1種類以上の商品購入によって発火するキャンペーンの指定フラグ
    MaxPointAmount = 8757,  // キャンペーンによって付与されるポイントの上限
    MaxTotalPointAmount = 790,  // キャンペーンによって付与されるの1人当たりの累計ポイントの上限
    ApplicableAccountMetadata = new Dictionary<string, object>(){{"key","sex"}, {"value","male"}},  // ウォレットに紐付くメタデータが特定の値を持つときにのみ発火するキャンペーンを登録します。
    BudgetCapsAmount = 2006743864,  // キャンペーン予算上限
};
Response.Campaign response = await request.Send(client);
```
...
Request.ListCoupons request = new Request.ListCoupons(
    ...
    CouponId = "aJD",  // クーポンID
    CouponName = "K5H0",  // クーポン名
    IssuedShopName = "Q0QMJ",  // 発行店舗名
    AvailableShopName = "q2AC",  // 利用可能店舗名
    AvailableFrom = "2021-02-17T00:19:56.000000+09:00",  // 利用可能期間 (開始日時)
    AvailableTo = "2022-05-24T14:06:11.000000+09:00",  // 利用可能期間 (終了日時)
    Page = 1,  // ページ番号
    PerPage = 50,  // 1ページ分の取得数
};
...
Request.CreateCoupon request = new Request.CreateCoupon(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
    "5RFdPBYQy3c",
    "2022-07-26T00:41:05.000000+09:00",
    "2020-01-22T02:35:28.000000+09:00",
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" // 発行元の店舗ID
) {
    Description = "VFZKAHKT4SzOjVOnkH84en1S9SJSqkP72u4fFyE010V9aAUIXX4s3TDoGIkCvbQnbJoWIqaIjBzaF8Qor9pyiNMpi96NO6g42ZhKEweHU9",
    DiscountAmount = 6665,
    DiscountPercentage = 2811.0,
    DiscountUpperLimit = 8957,
    DisplayStartsAt = "2021-01-07T08:40:02.000000+09:00",  // クーポンの掲載期間(開始日時)
    DisplayEndsAt = "2022-01-07T14:26:06.000000+09:00",  // クーポンの掲載期間(終了日時)
    IsDisabled = false,  // 無効化フラグ
    IsHidden = true,  // クーポン一覧に掲載されるかどうか
    IsPublic = true,  // アプリ配信なしで受け取れるかどうか
    Code = "Yu5",  // クーポン受け取りコード
    UsageLimit = 4449,  // ユーザごとの利用可能回数(NULLの場合は無制限)
    MinAmount = 3080,  // クーポン適用可能な最小取引額
...
Request.UpdateCoupon request = new Request.UpdateCoupon(
    ...
    Name = "RUG6pdP9fuV1JV9iUHaIRKeChG6WWQUZtz9RK0U9PGrjvrmCVkI1KooYyiqUipFlFsfJEA6lZz5g4mEGxZ8EGi",
    Description = "UdFlKBWMblgpBV7LHzFGREXwbkbjmtRtMmTUIevRXXfd9MSTXyajbaaIZu3Xc9lqLvwnDCBYBYrgoQuTPwbG8akUIVJSqzsjsw2F7mq0hk2GpLvrELrRNrcJE29Efmf3kf0GCzLsZgLWF4LQ9e3Dpg9QT4d4YNEhYkxWxDNVRdGGUclMocM87naTcVvAWlnGqgXlOLSzvNjsEpj8sHMY9g",
    DiscountAmount = 7187,
    DiscountPercentage = 9973.0,
    DiscountUpperLimit = 2458,
    StartsAt = "2020-06-25T00:05:46.000000+09:00",
    EndsAt = "2021-03-27T18:34:33.000000+09:00",
    DisplayStartsAt = "2023-11-14T22:42:48.000000+09:00",  // クーポンの掲載期間(開始日時)
    DisplayEndsAt = "2023-04-30T21:35:16.000000+09:00",  // クーポンの掲載期間(終了日時)
    IsDisabled = true,  // 無効化フラグ
    IsHidden = true,  // クーポン一覧に掲載されるかどうか
    IsPublic = true,  // アプリ配信なしで受け取れるかどうか
    Code = "dRI",  // クーポン受け取りコード
    UsageLimit = 9933,  // ユーザごとの利用可能回数(NULLの場合は無制限)
    MinAmount = 1776,  // クーポン適用可能な最小取引額
    IsShopSpecified = true,  // 特定店舗限定のクーポンかどうか
...
Request.CreateBank request = new Request.CreateBank(
    ...
    Email = "8VJVcCr1Sw@WXtd.com",  // ユーザーのメールアドレス

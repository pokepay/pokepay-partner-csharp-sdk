...
{
    public class CancelBulkTransaction
    {
        ...
        private string path { get { return "/bulk-transactions" + "/" + BulkTransactionId + "/cancel"; } }

        private static readonly HttpMethod method = new HttpMethod("POST");

#if NETFRAMEWORK
        public async Task<BulkTransaction> Send(Client client) {
                string res = await client.Send(path, CancelBulkTransaction.method, this);

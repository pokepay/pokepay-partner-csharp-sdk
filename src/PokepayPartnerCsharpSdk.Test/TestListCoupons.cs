        ...
        public async Task ListCoupons3()
        {
            try {
                Request.ListCoupons request = new Request.ListCoupons(
                    ...
                    AvailableTo = "2020-06-15T13:24:22.000000+09:00",
                    Page = 8382,
                    PerPage = 1415,
                };
                Response.PaginatedCoupons response = await request.Send(client);
        ...
        public async Task ListCoupons4()
        {
            try {
                Request.ListCoupons request = new Request.ListCoupons(
                    ...
                    AvailableFrom = "2022-07-07T12:03:30.000000+09:00",
                    AvailableTo = "2024-03-16T11:48:43.000000+09:00",
                    Page = 5387,
                    PerPage = 6558,
                };
                Response.PaginatedCoupons response = await request.Send(client);
        ...
        public async Task ListCoupons5()
        {
            try {
                Request.ListCoupons request = new Request.ListCoupons(
                    ...
                    AvailableFrom = "2023-10-16T13:14:07.000000+09:00",
                    AvailableTo = "2023-02-01T02:23:36.000000+09:00",
                    Page = 5410,
                    PerPage = 8238,
                };
                Response.PaginatedCoupons response = await request.Send(client);
        ...
        public async Task ListCoupons6()
        {
            try {
                Request.ListCoupons request = new Request.ListCoupons(
                    ...
                    AvailableFrom = "2022-05-23T02:13:37.000000+09:00",
                    AvailableTo = "2020-06-09T01:09:47.000000+09:00",
                    Page = 4092,
                    PerPage = 5130,
                };
                Response.PaginatedCoupons response = await request.Send(client);
        ...
        public async Task ListCoupons7()
        {
            try {
                Request.ListCoupons request = new Request.ListCoupons(
                    ...
                    AvailableFrom = "2021-04-02T07:43:37.000000+09:00",
                    AvailableTo = "2022-06-18T14:13:01.000000+09:00",
                    Page = 8088,
                    PerPage = 2652,
                };
                Response.PaginatedCoupons response = await request.Send(client);
        ...
        public async Task ListCoupons8()
        {
            try {
                Request.ListCoupons request = new Request.ListCoupons(
                    ...
                    AvailableFrom = "2024-01-31T15:16:32.000000+09:00",
                    AvailableTo = "2022-07-23T13:58:10.000000+09:00",
                    Page = 327,
                    PerPage = 2797,
                };
                Response.PaginatedCoupons response = await request.Send(client);

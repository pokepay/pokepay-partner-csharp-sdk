        ...
        public async Task ListCustomerTransactions3()
        {
            try {
                Request.ListCustomerTransactions request = new Request.ListCustomerTransactions(
                    ...
                    To = "2022-04-26T16:16:13.000000Z",
                    Page = 487,
                    PerPage = 8812,
                };
                Response.PaginatedTransaction response = await request.Send(client);
        ...
        public async Task ListCustomerTransactions5()
        {
            try {
                Request.ListCustomerTransactions request = new Request.ListCustomerTransactions(
                    ...
                    IsModified = false,
                    From = "2024-01-20T10:38:15.000000Z",
                    To = "2020-12-24T04:11:14.000000Z",
                    Page = 1772,
                    PerPage = 2425,
                };
                Response.PaginatedTransaction response = await request.Send(client);
        ...
        public async Task ListCustomerTransactions6()
        {
            try {
                Request.ListCustomerTransactions request = new Request.ListCustomerTransactions(
                    ...
                    Type = "expire",
                    IsModified = true,
                    From = "2021-02-13T04:32:34.000000Z",
                    To = "2023-04-22T03:17:43.000000Z",
                    Page = 1927,
                    PerPage = 8887,
                };
                Response.PaginatedTransaction response = await request.Send(client);
        ...
        public async Task ListCustomerTransactions7()
        {
            try {
                Request.ListCustomerTransactions request = new Request.ListCustomerTransactions(
                    ...
                    Type = "cashback",
                    IsModified = true,
                    From = "2022-04-09T19:16:32.000000Z",
                    To = "2020-01-17T21:38:30.000000Z",
                    Page = 4141,
                    PerPage = 1276,
                };
                Response.PaginatedTransaction response = await request.Send(client);
        ...
        public async Task ListCustomerTransactions8()
        {
            try {
                Request.ListCustomerTransactions request = new Request.ListCustomerTransactions(
                    ...
                    Type = "exchange",
                    IsModified = false,
                    From = "2021-01-04T01:35:51.000000Z",
                    To = "2023-11-16T04:08:27.000000Z",
                    Page = 7990,
                    PerPage = 9650,
                };
                Response.PaginatedTransaction response = await request.Send(client);

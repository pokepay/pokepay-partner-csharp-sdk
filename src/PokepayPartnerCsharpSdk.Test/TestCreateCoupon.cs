        ...
        public async Task CreateCoupon0()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    "2020-01-05T02:33:18.000000+09:00",
                    "2023-12-03T02:07:18.000000+09:00",
        ...
        public async Task CreateCoupon8()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DiscountAmount = 6808,
                    DisplayEndsAt = "2021-05-02T10:23:42.000000+09:00",
                    IsDisabled = false,
                    IsHidden = true,
                    IsPublic = true,
                    Code = "XvMXdIXxGA",
        ...
        public async Task CreateCoupon9()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DiscountAmount = 8541,
                    DisplayStartsAt = "2020-11-19T20:34:12.000000+09:00",
                    DisplayEndsAt = "2023-08-24T18:20:23.000000+09:00",
                    IsDisabled = true,
                    IsHidden = true,
                    IsPublic = false,
                    Code = "Z",
        ...
        public async Task CreateCoupon10()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2021-04-07T09:51:20.000000+09:00",
                    DisplayEndsAt = "2023-03-10T15:15:22.000000+09:00",
                    IsDisabled = false,
                    IsHidden = true,
                    IsPublic = false,
                    Code = "P",
        ...
        public async Task CreateCoupon11()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2022-02-17T13:36:31.000000+09:00",
                    DisplayEndsAt = "2021-01-02T18:17:49.000000+09:00",
                    IsDisabled = true,
                    IsHidden = true,
                    IsPublic = false,
                    Code = "1E81",
        ...
        public async Task CreateCoupon20()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayEndsAt = "2022-12-29T15:05:28.000000+09:00",
                    IsDisabled = true,
                    IsHidden = true,
                    IsPublic = true,
                    Code = "7PJayBT5Ig",
        ...
        public async Task CreateCoupon21()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2024-02-03T11:17:15.000000+09:00",
                    DisplayEndsAt = "2024-01-18T04:11:46.000000+09:00",
                    IsDisabled = false,
                    IsHidden = false,
                    IsPublic = false,
                    Code = "uSxp7i1rc",
        ...
        public async Task CreateCoupon22()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2023-03-21T19:50:49.000000+09:00",
                    DisplayEndsAt = "2023-11-06T14:03:41.000000+09:00",
                    IsDisabled = true,
                    IsHidden = true,
                    IsPublic = false,
                    Code = "ViuwKt",
        ...
        public async Task CreateCoupon23()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2022-08-25T11:20:42.000000+09:00",
                    DisplayEndsAt = "2021-05-19T01:35:12.000000+09:00",
                    IsDisabled = true,
                    IsHidden = true,
                    IsPublic = false,
                    Code = "pC8utok",
        ...
        public async Task CreateCoupon32()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayEndsAt = "2021-06-28T16:41:32.000000+09:00",
                    IsDisabled = false,
                    IsHidden = true,
                    IsPublic = true,
                    Code = "Q",
        ...
        public async Task CreateCoupon33()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2022-09-17T22:51:29.000000+09:00",
                    DisplayEndsAt = "2022-11-24T11:06:39.000000+09:00",
                    IsDisabled = false,
                    IsHidden = true,
                    IsPublic = false,
                    Code = "L88aL",
        ...
        public async Task CreateCoupon34()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2023-10-10T18:05:25.000000+09:00",
                    DisplayEndsAt = "2021-08-18T04:51:24.000000+09:00",
                    IsDisabled = false,
                    IsHidden = false,
                    IsPublic = true,
                    Code = "XIU",
        ...
        public async Task CreateCoupon35()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2023-03-29T22:56:31.000000+09:00",
                    DisplayEndsAt = "2021-05-09T05:42:20.000000+09:00",
                    IsDisabled = true,
                    IsHidden = true,
                    IsPublic = false,
                    Code = "fGNC0wV",
        ...
        public async Task CreateCoupon44()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayEndsAt = "2022-02-02T07:15:39.000000+09:00",
                    IsDisabled = false,
                    IsHidden = false,
                    IsPublic = true,
                    Code = "fo",
        ...
        public async Task CreateCoupon45()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2021-03-31T10:30:04.000000+09:00",
                    DisplayEndsAt = "2023-10-18T11:21:08.000000+09:00",
                    IsDisabled = true,
                    IsHidden = false,
                    IsPublic = false,
                    Code = "PQLWJArP",
        ...
        public async Task CreateCoupon46()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2022-08-29T16:53:22.000000+09:00",
                    DisplayEndsAt = "2022-01-14T05:47:38.000000+09:00",
                    IsDisabled = true,
                    IsHidden = false,
                    IsPublic = false,
                    Code = "Ja8YkV10V0",
        ...
        public async Task CreateCoupon47()
        {
            try {
                Request.CreateCoupon request = new Request.CreateCoupon(
                    ...
                    DisplayStartsAt = "2021-05-07T23:33:42.000000+09:00",
                    DisplayEndsAt = "2021-10-06T04:45:26.000000+09:00",
                    IsDisabled = false,
                    IsHidden = false,
                    IsPublic = false,
                    Code = "Usw4hfYXr",
